      ...
      {licenses.length > 0 && (
        <div className="grid grid-cols-3 gap-4">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-center">
                <p className="text-sm text-slate-500 dark:text-slate-400 mb-1">Aktivierte Domains</p>
                <p className="text-3xl font-bold text-slate-900 dark:text-white">{totalDomains}</p>
              </div>
            </CardContent>
          </Card>
        </div>
