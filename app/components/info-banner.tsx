...
export function InfoBanner({ target }: InfoBannerProps) {
  ...
  useEffect(() => {
    ...
    fetch(`/api/infobanner?target=${target}`)
      .then(res => res.json())
      .then(data => {
  ...
  return (
    <div 
      className="w-full h-[50px] flex items-center justify-center px-4 relative"
      style={{ 
