...
class GermanFence_AntiSpam {
    ...
    private function generate_session_token() {
        ...
        // Session data is set by plugin, but sanitize on return for WordPress.org compliance
        return isset($_SESSION[$this->session_key]) ? sanitize_text_field($_SESSION[$this->session_key]) : '';
    }
    ...
    public function check_honeypot($data) {
        ...
        $previous_hour = gmdate( 'YmdH', strtotime( '-1 hour' ) );
