...
class German_Shield_PhraseBlocking {
    ...
    private function collect_content($data) {
        ...
        $skip_fields = array(
            ...
            'action', 'submit', 'german_shield_nonce'
        );
    ...
    private function matches_regex($content, $pattern) {
        ...
        try {
            ...
            if (@preg_match($pattern, '') === false) {
                German_Shield_Logger::log('[PHRASE-REGEX] Ungültiges Regex-Pattern: ' . $pattern);
                return false;
            }
            ...
            if ($result === 1) {
                German_Shield_Logger::log('[PHRASE-REGEX] Match gefunden: ' . $pattern);
                return true;
            }
            ...
            German_Shield_Logger::log_error('[PHRASE-REGEX] Exception: ' . $e->getMessage());
            return false;
        }
    }
    ...
    public function import_common_phrases() {
        ...
        update_option('german_shield_settings', $this->settings);
