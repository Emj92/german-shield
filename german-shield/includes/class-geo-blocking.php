...
class German_Shield_GeoBlocking {
    ...
    public function enqueue_assets($hook) {
        ...
        wp_enqueue_script(
            'german-shield-geo',
            GERMAN_SHIELD_PLUGIN_URL . 'assets/js/geo-blocking.js',
            array('jquery'),
            filemtime(GERMAN_SHIELD_PLUGIN_DIR . 'assets/js/geo-blocking.js'),
            true
        );
    }
    ...
    public function render_tab($settings, $license_info) {
        ?>
        <div class="german-shield-tab-content" id="tab-geo">
            <div class="german-shield-section">
                ...
                <?php if (!$license_info['is_valid']): ?>
                    <div style="background: rgba(34, 214, 221, 0.1); padding: 30px; border-radius: 6px; border: 2px solid rgba(34, 214, 221, 0.3); text-align: center;">
                        ...
                        <a href="<?php echo admin_url('admin.php?page=german-shield&tab=license'); ?>" class="german-shield-btn-primary">Jetzt Lizenz aktivieren →</a>
                    </div>
                <?php else: ?>
                    
                    <!-- Toggle (Auto-Save) -->
                    <div style="background: #fff; padding: 25px; border: 1px solid #c3cbd5; border-radius: 6px; margin-bottom: 30px;">
                        <div class="german-shield-setting" style="border: none; padding: 0; margin: 0;">
                            <label class="german-shield-toggle" id="geo-main-toggle">
                            ...
                            <div class="setting-info">
                                ...
                                <p style="margin: 0;">Blockiere Anfragen aus bestimmten Ländern.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="geo-countries-section" style="<?php echo $settings['geo_blocking_enabled'] !== '1' ? 'display:none;' : ''; ?>">
                        <div style="background: #F2F5F8; padding: 25px; border: 1px solid #c3cbd5; border-radius: 6px;">
                            <h3 style="margin: 0 0 10px 0;">Blockierte Länder</h3>
                            <p style="color: #646970; margin: 0 0 15px 0;">Klicke auf ein Land um es zu blockieren/freizugeben. Speichert automatisch.</p>
