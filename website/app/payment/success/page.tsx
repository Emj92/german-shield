...
function PaymentSuccessContent() {
  ...
  return (
    <div className="min-h-screen bg-[#F2F5F8] dark:bg-slate-950 flex items-center justify-center p-6">
      ...
      <header className="fixed top-0 w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-md z-50 border-b border-slate-200 dark:border-slate-800">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <Image src="/germanfence_logo.png" alt="GermanFence" width={40} height={40} className="drop-shadow-md" />
            <span className="text-xl font-bold text-[#22D6DD]">GermanFence</span>
          </Link>
      ...
      <Card className="max-w-2xl w-full border-2 border-slate-200 dark:border-[#22D6DD] bg-white dark:bg-slate-900/80 shadow-xl rounded-2xl mt-16">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800/50 rounded-xl p-5 border border-[#d9dde1] dark:border-slate-700">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 dark:text-white mb-1">E-Mail gesendet!</h3>
          ...
          <div className="bg-white dark:bg-slate-800/50 rounded-xl p-5 border border-[#d9dde1] dark:border-slate-700">
            ...
            <ol className="space-y-3 text-slate-700 dark:text-slate-300">
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#22D6DD] text-white flex items-center justify-center text-sm font-bold">1</span>
                <span><strong>E-Mail prüfen:</strong> Klicke auf den Link in der E-Mail, um dein Passwort zu setzen.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#22D6DD] text-white flex items-center justify-center text-sm font-bold">2</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="https://germanfence.de/downloads/germanfence-plugin.zip" download className="flex-1">
              <Button className="w-full bg-[#22D6DD] hover:bg-[#22D6DD] text-white font-semibold h-12 rounded-xl">
                <Download className="mr-2 h-5 w-5" />
                Plugin herunterladen
              </Button>
            </a>
            <Link href="https://portal.germanfence.de/login" className="flex-1">
              <Button variant="outline" className="w-full border-2 border-[#22D6DD] text-[#22D6DD] hover:bg-transparent hover:border-[#22D6DD] hover:text-[#22D6DD] h-12 rounded-xl">
