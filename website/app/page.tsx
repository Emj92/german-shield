    ...
    <div className="min-h-screen relative bg-[#FAFAFA] dark:bg-slate-950">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            <Card className="border-4 border-[#22D6DD] relative shadow-xl scale-105 flex flex-col h-full">
              ...
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-4xl">1,00€/Jahr</CardTitle>
                <CardDescription className="text-lg mt-2">
            ...
            <Card className="border-2 border-[#F06292] flex flex-col h-full">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-4xl">2,50€/Jahr</CardTitle>
                <CardDescription className="text-lg mt-2">
      ...
      <footer className="pt-20 pb-5 px-6 bg-slate-900 text-white">
        <div className="container mx-auto max-w-7xl">
          <div className="grid md:grid-cols-[1fr_1fr_1.2fr_1fr] gap-8 mb-12">
            <div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-slate-400">
                <li><a href="#pricing" className="hover:text-[#22D6DD] transition">Single (39€/Jahr zzgl. MwSt.)</a></li>
                <li><a href="#pricing" className="hover:text-[#22D6DD] transition">Freelancer (1,00€/Jahr zzgl. MwSt.) TEST</a></li>
                <li><a href="#pricing" className="hover:text-[#22D6DD] transition">Agency (2,50€/Jahr zzgl. MwSt.) TEST</a></li>
