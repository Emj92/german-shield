          ...
          <div className="relative bg-white dark:bg-slate-900 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 border border-slate-300 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 focus:bg-[#22D6DD]/10 focus:border-[#22D6DD] dark:focus:border-[#22D6DD] outline-none transition-all"
                      required
                    />
                  </div>
                </div>
                ...
                {/* Firmen-Checkbox */}
                <div className="flex items-center gap-3 p-4 bg-[#FAFAFA] dark:bg-slate-800/50 rounded-xl">
                  <input
                    type="checkbox"
                    id="isBusiness"
                    checked={isBusiness}
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <select
                            ...
                            className="w-full pl-10 pr-4 py-3 border border-slate-300 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:bg-[#22D6DD]/10 focus:border-[#22D6DD] dark:focus:border-[#22D6DD] outline-none transition-all appearance-none"
                            required
                          >
                            {countries.map(c => (
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 border rounded-xl bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 focus:bg-[#22D6DD]/10 outline-none transition-all ${
                            vatValid ? 'border-green-500' : 'border-slate-300 dark:border-slate-700'
                          }`}
                          required
                        />
                        {vatValid && (
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="12345"
                          className="w-full px-4 py-3 border border-slate-300 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 focus:bg-[#22D6DD]/10 focus:border-[#22D6DD] dark:focus:border-[#22D6DD] outline-none transition-all"
                          required
                        />
                      </div>
